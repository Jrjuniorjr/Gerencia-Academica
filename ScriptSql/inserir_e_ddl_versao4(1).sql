...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Aluno` (`cpf`, `Nome`, `Sobrenome`, `Tipo`, `Data_nascimento`) VALUES ('987654321', 'Jennifer', 'Calazans', 'Vestibular', '1997/10/05');
INSERT INTO `mydb`.`Aluno` (`cpf`, `Nome`, `Sobrenome`, `Tipo`, `Data_nascimento`) VALUES ('998765432', 'Alisson', 'Barboza', 'Transferencia', '1926/08/02');
INSERT INTO `mydb`.`Aluno` (`cpf`, `Nome`, `Sobrenome`, `Tipo`, `Data_nascimento`) VALUES ('999876543', 'Momedes', 'Junior', 'Vestibular', '1998/06/03');
INSERT INTO `mydb`.`Aluno` (`cpf`, `Nome`, `Sobrenome`, `Tipo`, `Data_nascimento`) VALUES ('999987654', 'Lucas', 'Leal', 'Vestibular', '1995/07/09');
INSERT INTO `mydb`.`Aluno` (`cpf`, `Nome`, `Sobrenome`, `Tipo`, `Data_nascimento`) VALUES ('999998765', 'Creuza', 'Silva', 'Transferencia', '1999/01/01');
INSERT INTO `mydb`.`Aluno` (`cpf`, `Nome`, `Sobrenome`, `Tipo`, `Data_nascimento`) VALUES ('999999876', 'Veva', 'Aragao', 'Transferencia', '1989/03/01');
INSERT INTO `mydb`.`Aluno` (`cpf`, `Nome`, `Sobrenome`, `Tipo`, `Data_nascimento`) VALUES ('111111111', 'João', 'Bosco', 'Transferencia', '1995/05/01');
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Matricula` (`num_matricula`, `codigo_curso`, `tipo`, `Data_inicio`, `aluno_cpf`) VALUES (123456789, 'C3', 'Ativo', '2016/02/02', 987654321);
INSERT INTO `mydb`.`Matricula` (`num_matricula`, `codigo_curso`, `tipo`, `Data_inicio`, `aluno_cpf`) VALUES (123456788, 'C3', 'Ativo', '2016/02/02', 998765432);
INSERT INTO `mydb`.`Matricula` (`num_matricula`, `codigo_curso`, `tipo`, `Data_inicio`, `aluno_cpf`) VALUES (123456888, 'C3', 'Ativo', '2016/02/08', 999876543);
INSERT INTO `mydb`.`Matricula` (`num_matricula`, `codigo_curso`, `tipo`, `Data_inicio`, `aluno_cpf`) VALUES (123458888, 'C3', 'Ativo', '2016/08/13', 999987654);
INSERT INTO `mydb`.`Matricula` (`num_matricula`, `codigo_curso`, `tipo`, `Data_inicio`, `aluno_cpf`) VALUES (123488888, 'M1', 'Ativo', '2017/08/08', 999998765);
INSERT INTO `mydb`.`Matricula` (`num_matricula`, `codigo_curso`, `tipo`, `Data_inicio`, `aluno_cpf`) VALUES (123888888, 'E3', 'Inativo', '2013/02/05', 999999876);
INSERT INTO `mydb`.`Matricula` (`num_matricula`, `codigo_curso`, `tipo`, `Data_inicio`, `aluno_cpf`) VALUES (128888888, 'E3', 'Ativo', '2014/02/02', 111111111);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Aluno_Endereco` (`cpf`, `rua`, `cep`, `bairro`) VALUES ('987654321', 'Av boa viagem', '5100000', 'Madalena');
INSERT INTO `mydb`.`Aluno_Endereco` (`cpf`, `rua`, `cep`, `bairro`) VALUES ('998765432', 'Antenor Navarro', '4100000', 'Brega');
INSERT INTO `mydb`.`Aluno_Endereco` (`cpf`, `rua`, `cep`, `bairro`) VALUES ('999876543', 'Espinheiro', '5101111', 'Assunção');
INSERT INTO `mydb`.`Aluno_Endereco` (`cpf`, `rua`, `cep`, `bairro`) VALUES ('999987654', 'Casa Amarela', '5111111', 'Frevo');
INSERT INTO `mydb`.`Aluno_Endereco` (`cpf`, `rua`, `cep`, `bairro`) VALUES ('999998765', 'Alelo', '3111111', 'Ipiraçuru');
INSERT INTO `mydb`.`Aluno_Endereco` (`cpf`, `rua`, `cep`, `bairro`) VALUES ('999999876', 'Bigorna', '2121212', 'Arapiraca');
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Historico` (`num_matricula`, `codigo_disciplina`, `nota_final`, `data_cursada`) VALUES (123456789, 'INF0102', 8.2, '2017/11/24');
INSERT INTO `mydb`.`Historico` (`num_matricula`, `codigo_disciplina`, `nota_final`, `data_cursada`) VALUES (123456788, 'INF0103', 6.8, '2016/11/26');
INSERT INTO `mydb`.`Historico` (`num_matricula`, `codigo_disciplina`, `nota_final`, `data_cursada`) VALUES (123456888, 'INF0103', 7.0, '2016/12/05');
INSERT INTO `mydb`.`Historico` (`num_matricula`, `codigo_disciplina`, `nota_final`, `data_cursada`) VALUES (123458888, 'INF0103', 7.5, '2016/12/05');
INSERT INTO `mydb`.`Historico` (`num_matricula`, `codigo_disciplina`, `nota_final`, `data_cursada`) VALUES (123888888, 'CIV0301', 7.2, '2016/11/29');
INSERT INTO `mydb`.`Historico` (`num_matricula`, `codigo_disciplina`, `nota_final`, `data_cursada`) VALUES (123488888, 'MED0203', 9.2, '2017/12/06');
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Cursando` (`matricula`, `codigo_disciplina`, `primeiro_gq`, `segundo_gq`) VALUES (123456888, 'INF0102', 5.6, NULL);
INSERT INTO `mydb`.`Cursando` (`matricula`, `codigo_disciplina`, `primeiro_gq`, `segundo_gq`) VALUES (123488888, 'MED0202', 7.6, 5.9);
INSERT INTO `mydb`.`Cursando` (`matricula`, `codigo_disciplina`, `primeiro_gq`, `segundo_gq`) VALUES (123488888, 'MED0203', 6.8, NULL);
INSERT INTO `mydb`.`Cursando` (`matricula`, `codigo_disciplina`, `primeiro_gq`, `segundo_gq`) VALUES (123456888, 'INF0103', 0, 0);
